...
class Application(dbus.service.Object):
    ...
    def __init__(self, bus):
        self.path = '/org/bluez/gatt_app/dock_station_1747828571'
        self.services = []
        dbus.service.Object.__init__(self, bus, self.path)
        # Сервисы добавляются снаружи
...
class DockStationService(Service):
    """
    Dock Station Service
    """
    DOCK_SVC_UUID = '8ec91400-f315-4f60-9fb8-838830daea50'

    def __init__(self, bus, index):
        Service.__init__(self, bus, index, self.DOCK_SVC_UUID, True)
        self.add_characteristic(DockStationCharacteristic(bus, 0, self))

class DockStationCharacteristic(Characteristic):
    """
    Dock Station Characteristic
    """
    DOCK_CHRC_UUID = '8ec91401-f315-4f60-9fb8-838830daea50'
...
def gatt_server_main(mainloop, bus, adapter_name, app=None):
    try:
        ...
        if not app:
            app = Application(bus)
            app.add_service(DockStationService(bus, 0))
        ...
        print('Error in gatt_server_main:', str(e))
