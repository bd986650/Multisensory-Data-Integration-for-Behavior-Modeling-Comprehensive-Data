...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxHealthConnectLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>healthConnectClient</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class GmsPlayServicesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>playServicesFitnessVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getFitness() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("gms.play.services.fitness");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        private final PlayServicesFitnessLibraryAccessors laccForPlayServicesFitnessLibraryAccessors = new PlayServicesFitnessLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>play.services.fitness</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PlayServicesFitnessLibraryAccessors getFitness() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPlayServicesFitnessLibraryAccessors;
        }
    ...
    public static class PlayServicesAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2120</b> with <b>com.google.android.gms:play-services-auth</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV2120() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.auth.v2120");
        }
     ...
     */
    @Deprecated
    public static class PlayServicesFitnessLibraryAccessors extends SubDependencyFactory {

        public PlayServicesFitnessLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v2100</b> with <b>com.google.android.gms:play-services-fitness</b> coordinates and
         * with version reference <b>googlePlayServicesFitness</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getV2100() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.fitness.v2100");
        }

        /**
         * Dependency provider for <b>v2120</b> with <b>com.google.android.gms:play-services-fitness</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV2120() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.fitness.v2120");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>googlePlayServicesFitness</b> with value <b>21.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGooglePlayServicesFitness() { return getVersion("googlePlayServicesFitness"); }

        /**
         * Version alias <b>healthConnectClient</b> with value <b>1.1.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHealthConnectClient() { return getVersion("healthConnectClient"); }
        ...
        /**
         * Version alias <b>playServicesAuth</b> with value <b>20.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesFitnessVersion</b> with value <b>20.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesFitnessVersion() { return getVersion("playServicesFitnessVersion"); }
